...
export const COCKTAIL_COLOR_MAP = {
  [COCKTAIL_TYPE.MOJITO]: "#5f7302",
  [COCKTAIL_TYPE.WHISKEY_SOUR]: "#ff6a00",
  [COCKTAIL_TYPE.BLUEBERRY_GIN_FIZZ]: "#c711bb",
  [COCKTAIL_TYPE.STRAWBERRY_GIN_SMASH]: "#f7122c",
  [COCKTAIL_TYPE.CHERRY_CAIPIROSKA]: "#f3111e",
};
